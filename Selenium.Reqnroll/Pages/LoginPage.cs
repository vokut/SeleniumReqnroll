...
namespace Selenium.Reqnroll.Pages
{
    public class LoginPage : ILoginPage
    {
        ...
        private readonly IHeaderPage _headerPage;
            ...
            IHeaderPage headerPage)
        {
            ...
            _headerPage = headerPage ?? throw new ArgumentNullException(nameof(headerPage));
        }
        ...
        public void PerformLogin(bool navigate = true)
        {
            ...
            _waitHelpers.WaitForElementVisible(_headerPage.BreadcrumbModule("Dashboard"), timeoutSeconds: 15);
        }
